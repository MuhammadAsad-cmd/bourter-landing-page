    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          {t("companyPage.form.login.welcomeBack")}
        </h2>
        <p className="text-gray-600">{t("companyPage.form.login.loginToContinue")}</p>
      </div>
      ...
      <div className="group">
        <label className="block text-sm font-bold text-gray-700 mb-2 group-focus-within:text-primary transition-colors">
          {t("companyPage.form.login.emailAddress")}
        </label>
        <div className="relative">
          <input
            ...
            placeholder={t("companyPage.form.login.emailPlaceholder")}
      ...
      <div className="group">
        <label className="block text-sm font-bold text-gray-700 mb-2 group-focus-within:text-primary transition-colors">
          {t("companyPage.form.login.password")}
        </label>
        <div className="relative">
          <input
            ...
            onChange={handleLoginChange}
            placeholder={t("companyPage.form.login.passwordPlaceholder")}
